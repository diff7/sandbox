...
class Trainer:
    def __init__(self, params):
        self.params = params
        self.model = Transformer(params['num_layers'],
                    params['d_model'],
                    params['num_heads'],
                    params['dff'],
        ...
        self.opt = tf.keras.optimizers.Adam(learning_rate, beta_1=0.9, beta_2=0.98,
                                     epsilon=1e-9)
    ...
    def plot_attention_weights(self,
      ...
      for head in range(attention.shape[0]):
        ...
        ax.set_yticklabels([tokenizer_tar.decode([i]) for i in result
    ...
    def translate(self, sentence, tokenizer_tar, plot=''):
      # e.g plot = 'decoder_layer4_block2'
      result, attention_weights = evaluate(sentence)

      predicted_sentence = tokenizer_tar.decode([i for i in result
